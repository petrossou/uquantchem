SUBROUTINE countee(BAS,IND1,IND2,IND3,IND4,Istart,Iend,PRYSR,PRYSW,numprocessors,APPROXEE,Tol,id,DMAT,CREATEMAPPING,NDIAG,NONZERO,TOTALNONZERO,dInts)
      ...
      INTEGER, INTENT(IN) :: id,numprocessors,Istart,Iend
      ...
      INTEGER, INTENT(INOUT) :: NONZERO,NDIAG
      INTEGER, INTENT (OUT) :: TOTALNONZERO
      ...
      INTEGER :: I,J,K,L,M,N,NN,MM,P,Q,G,IJ,KL,L1,M1,N1,L2,M2,N2,L3,M3,N3,L4,M4,N4,NSTART,GG,STRL,KK,PP,PPP
      INTEGER :: rcounts(numprocessors),displs(numprocessors),ierr,scount,SI,SIC(numprocessors),NONZEROSAVE

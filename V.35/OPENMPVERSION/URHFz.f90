SUBROUTINE URHFz(S,H0,Intsv,NB,NRED,Ne,nucE,Tol,EHFeigenup,EHFeigendown,ETOT,Cup,Cdown,Pup,Pdown,MIX,DIISORD,DIISSTART,&
                & NSCF,FIXNSCF,POUT,SCRATCH,ZEROSCF,Jup,Jdown,Kup,Kdown,ETEMP,ENTROPY,NBAUX,VRI,WRI,RIAPPROX)
      ...
      DOUBLE PRECISION :: PT(NB,NB),TOLDNe
      DOUBLE PRECISION :: Fup(NB,NB),Fdown(NB,NB),G(NB,NB),C1(NB,NB),C2(NB,NB),C3(NB,NB),C4(NB,NB),DE,EOLD,DELTAP,LAMDAu,LAMDAd,MIXING,FTOT,FOLD
      DOUBLE PRECISION :: PTold(NB,NB),Pupold(NB,NB),Pdownold(NB,NB),Pups(50,NB,NB),Pdowns(50,NB,NB),Pupt(NB,NB),Pdownt(NB,NB),mu

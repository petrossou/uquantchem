...
SUBROUTINE VLYPA(rha,rhb,grha,grhb,Vc)
             ...
             & ( (delta-11.0d0)/(9.0d0*rh) - (1.0d0/9.0d0)*ddelta )*( (rha/rh)*ga + (rhb/rh)*gb ) - ((delta-11)/rh)*ga

             dep1drhb = (8.0d0/3.0d0)*2**(11.0d0/3.0d0)*CF*rhb**(5.0d0/3.0d0) + (1.0d0/18.0d0)*ddelta*( ga + gb - 7.0d0*gz ) + &
             & ( (delta-11.0d0)/(9.0d0*rh) - (1.0d0/9.0d0)*ddelta )*( (rha/rh)*ga + (rhb/rh)*gb ) - ((delta-11)/rh)*gb

SUBROUTINE vxc2(CORRLEVEL,BAS,Pup,Pdown,densu,densd,r,V)
        ...
        DOUBLE PRECISION, INTENT(IN) :: Pup(BAS%NBAS,BAS%NBAS), Pdown(BAS%NBAS,BAS%NBAS),r(3),densu,densd
        DOUBLE PRECISION, INTENT(OUT) :: V(2)
        DOUBLE PRECISION, EXTERNAL :: rho
        DOUBLE PRECISION :: dens,gdensu(3),gdensd(3),gdens(3),ldensu,ldensd

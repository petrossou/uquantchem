SUBROUTINE gradprimeeintegral(L1,M1,N1,A,alpha1,L2,M2,N2,B,alpha2,L3,M3,N3,C,alpha3,L4,M4,N4,D,alpha4,SAMECITE,PRYSR,PRYSW,grad)
      ...
      IF ( A(1) .EQ. B(1) .AND. A(2) .EQ. B(2) .AND. A(3) .EQ. B(3) ) THEN
              IF ( L1 + L2 .GT. 0 ) grad(1,1) = -(L1+L2)*primeeintegral(L1-1,M1,N1,A,alpha1,L2,M2,N2,B,alpha2,L3,M3,N3,C,alpha3,L4,M4,N4,D,alpha4,SAMECITE,PRYSR,PRYSW)
              ...
              IF ( M1 + M2 .GT. 0 ) grad(1,2) = -(M1+M2)*primeeintegral(L1,M1-1,N1,A,alpha1,L2,M2,N2,B,alpha2,L3,M3,N3,C,alpha3,L4,M4,N4,D,alpha4,SAMECITE,PRYSR,PRYSW)
              ...
              IF ( N1 + N2 .GT. 0 ) grad(1,3) = -(N1+N2)*primeeintegral(L1,M1,N1-1,A,alpha1,L2,M2,N2,B,alpha2,L3,M3,N3,C,alpha3,L4,M4,N4,D,alpha4,SAMECITE,PRYSR,PRYSW)
      ...
      IF ( C(1) .EQ. D(1) .AND. C(2) .EQ. D(2) .AND. C(3) .EQ. D(3) ) THEN
              IF ( L3 + L4 .GT. 0 ) grad(3,1) = -(L3+L4)*primeeintegral(L1,M1,N1,A,alpha1,L2,M2,N2,B,alpha2,L3-1,M3,N3,C,alpha3,L4,M4,N4,D,alpha4,SAMECITE,PRYSR,PRYSW)
              ...
              IF ( M3 + M4 .GT. 0 ) grad(3,2) = -(M3+M4)*primeeintegral(L1,M1,N1,A,alpha1,L2,M2,N2,B,alpha2,L3,M3-1,N3,C,alpha3,L4,M4,N4,D,alpha4,SAMECITE,PRYSR,PRYSW)
              ...
              IF ( N3 + N4 .GT. 0 ) grad(3,3) = -(N3+N4)*primeeintegral(L1,M1,N1,A,alpha1,L2,M2,N2,B,alpha2,L3,M3,N3-1,C,alpha3,L4,M4,N4,D,alpha4,SAMECITE,PRYSR,PRYSW)

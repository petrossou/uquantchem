FUNCTION quadcheck(CORRLEVEL,NATOMS,ATOMS,BAS,Pup,Pdown,gradS,LORDER,CGORDER,LQ,CGQ)
                ...
                DO m=1,LORDER           ! Loop over Lebedev quadrature over the surface of the sphere.
                        DO I=1,NATOMS   ! Loop over fuzzy voronoi polyheadra centered on each of the atoms.
                                ...
                                IF ( rad .LE. rcutt ) THEN 
                                        ...
                                        quadcheck = quadcheck  + 4*PI*p*CGQ(n,2)*LQ(m,3)*rho(BAS,Pup+Pdown,r)*faktor*rad**2
                                ENDIF
                         ENDDO
                ENDDO
        ENDDO

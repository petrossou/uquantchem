SUBROUTINE relax(gradS,gradT,gradV,gradIntsv,S,H0,Intsv,NB,NRED,Ne,nucE,Tol,MIX,DIISORD,DIISSTART,NATOMS,NSTEPS,DR,BAS,ATOMS,APPROXEE,CORRLEVEL,PRYSR,PRYSW)
      ...
      IF ( DE .LT. Tol ) THEN
              ...
              WRITE(*,*)'                 to the interatomic forces. An energy convergence of'
              WRITE(*,'(A29,E10.5,A24)')' DE < ',Tol,' [au] has been obtained.'
              WRITE(*,*)' ' 
      ...
      ELSE
              WRITE(*,*)' '
              WRITE(*,*)'          Failure to relax the nuclear positions within prescribed energy tolerance'
              WRITE(*,*)' ' 

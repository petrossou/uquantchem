SUBROUTINE getKvc(P,NB,NRED,Istart,Iend,Intsv,IND1,IND2,IND3,IND4,numprocessors,id,Kout)
      IMPLICIT NONE
      INCLUDE "mpif.h"
      ...
      DOUBLE PRECISION :: t1,t2,t3,t4,fact
      COMPLEX*16 :: Ksend(NB,NB),Krecieve(numprocessors)
      N = NB*NB
      ...
      ENDDO
      CALL MPI_REDUCE(Ksend,Kout,NB*NB,MPI_DOUBLE_COMPLEX,MPI_SUM,0,MPI_COMM_WORLD, ierr)
      CALL MPI_BCAST(Kout,NB*NB,MPI_DOUBLE_COMPLEX, 0, MPI_COMM_WORLD, ierr)

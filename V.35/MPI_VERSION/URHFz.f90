SUBROUTINE URHFz(S,H0,Intsv,IND1,IND2,IND3,IND4,Istart,Iend,NB,NRED,Ne,nucE,Tol,EHFeigenup,EHFeigendown,ETOT,Cup,Cdown,Pup,Pdown,MIX,DIISORD,DIISSTART,NSCF,FIXNSCF, &
              & numprocessors,id,POUT,SCRATCH,ZEROSCF,Jup,Jdown,Kup,Kdown,ETEMP,ENTROPY)
      ...
      DOUBLE PRECISION :: PT(NB,NB),C3(NB,NB),C4(NB,NB),mu

SUBROUTINE dftforcedensnip(CORRLEVEL,NATOMS,BAS,Pup,Pdown,r,BECKECENTER,excforcedens)
        ...
        !===================================================================!
        !====================================================================
        ! This subroutine is allmost the same as dftforceden.f90 except 
        ! that all contributions to the exchange-correlation force-density
        ! emenating from nuclear gradients applied to the density matrices
        ! have been excluded.
        !====================================================================
        USE datatypemodule
        USE exchcorrmodule

SUBROUTINE getxcforcenip(CORRLEVEL,NATOMS,ATOMS,BAS,Pup,Pdown,LORDER,CGORDER,LQ,CGQ,NTOTALQUAD,Q1,Q2,Q3,Qstart,Qend,numprocessors,id,xcforce)
        ...
        !======================================================================
        ! This subroutine is allmost the same as getxcforce.f90 except that all
        ! contributions to the exchange correlation force emmanating from
        ! nuclear gradients applied to the density matrices have been excluded
        !======================================================================
        USE datatypemodule
        IMPLICIT NONE
        INCLUDE "mpif.h"
        ...
        DO J=Qstart,Qend
               ...
               IF ( rad .LE. rcutt ) THEN  ! Cut off radius of 10*rm  is employed
                                        ...
                                        CALL dftforcedensnip(CORRLEVEL,NATOMS,BAS,Pup,Pdown,r,I,excforcedens)

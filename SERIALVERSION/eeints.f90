SUBROUTINE eeints(NATOMS,FNATOMS,BAS,Intsv,gradIntsv,NRED,FNRED,PRYSR,PRYSW,APPROXEE,Tol,CFORCE,DMAT)
      ...
      INTEGER, INTENT(IN) :: NRED,FNRED,NATOMS,FNATOMS
      ...
      DOUBLE PRECISION :: A(3),B(3),C(3),D(3),al1,al2,al3,al4,co1,co2,co3,co4,DMAXIMUM(6)
     ...
     DO GG=1,2
         ...
         !$OMP PRIVATE(DOSUMOVERPRIMS,SAMECITE,al1,al2,al3,al4,co1,co2,co3,co4,TERM,NP1,NP2,NP3,NP4)
